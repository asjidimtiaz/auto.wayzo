  ...
  return (
    <div className="animate-fadeIn space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-dark">Alertes & Notifications</h1>
          <p className="text-sm text-dark-muted">Paiements, formations et séances à surveiller</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button onClick={load} className="flex items-center gap-2 px-4 py-2 bg-white border border-surface-200 rounded-xl text-sm font-medium text-dark-muted hover:bg-surface-50 transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="bg-white rounded-3xl shadow-soft p-6 border-l-4 border-l-accent-red border-surface-100 flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-bold text-dark-muted uppercase tracking-wider mb-0.5">Urgentes</p>
            <p className="text-3xl font-bold text-dark">{loading ? '—' : stats.urgentes}</p>
          </div>
        </div>
        <div className="bg-white rounded-3xl shadow-soft p-6 border-l-4 border-l-accent-yellow border-surface-100 flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-bold text-dark-muted uppercase tracking-wider mb-0.5">Avertissements</p>
            <p className="text-3xl font-bold text-dark">{loading ? '—' : stats.avertissements}</p>
          </div>
        </div>
        <div className="bg-white rounded-3xl shadow-soft p-6 border-l-4 border-l-accent-blue border-surface-100 flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-bold text-accent-blue uppercase tracking-wider mb-0.5">Informations</p>
            <p className="text-3xl font-bold text-accent-blue">{loading ? '—' : stats.informations}</p>
          </div>
        </div>
        <div className="bg-white rounded-3xl shadow-soft p-6 border border-surface-100 flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-surface-100 flex items-center justify-center text-dark-muted">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
          </div>
          <div>
            <p className="text-xs font-bold text-dark-muted uppercase tracking-wider mb-0.5">Total</p>
